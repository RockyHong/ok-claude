...
<head>
<meta charset="utf-8" />
<title>What Did Claude Say</title>
<style>
...
<body>
<header>
  <h1>What Did Claude Say</h1>
  <p>${subhead}</p>
</header>
<main>
  <div id="cloud-wrap"><canvas id="cloud"></canvas></div>
</main>
<footer>generated by <code>npx whatdidclaudesay</code> · mechanical word frequency · all rendering offline</footer>
